/**
 * Create eBay Listing for Lung Detox Premium Cleanse (Single)
 * 
 ...
 * 
 * Usage:
 *   node create-ebay-listing-lung.js
 */
...
async function main() {
    ...
    console.log('eBay Listing Creator - Lung Detox Premium Cleanse (Single)');
    console.log('='.repeat(70));
    console.log('');
